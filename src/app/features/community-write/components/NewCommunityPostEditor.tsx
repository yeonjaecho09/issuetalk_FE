  ...
  return (
    <FormCard>
      <WriteForm onSubmit={onSubmit}>
        <FieldLabel>
          제목
          <TextInput type="text" placeholder="게시글 제목을 입력해 주세요" value={title} onChange={event => onChangeTitle(event.target.value)} />
        </FieldLabel>
        <FieldLabel>
          본문
          <EditorShell>
            <Toolbar>
              <ToolbarButton type="button" $active={toolbarState.bold} onClick={() => runCommand('bold')}>
                굵게
              </ToolbarButton>
              <ToolbarButton type="button" $active={toolbarState.italic} onClick={() => runCommand('italic')}>
                기울임
              </ToolbarButton>
              <ToolbarButton type="button" $active={toolbarState.strikeThrough} onClick={() => runCommand('strikeThrough')}>
                취소선
              </ToolbarButton>
              <ToolbarButton
                type="button"
              ...
              <ToolbarButton type="button" $active={toolbarState.blockquote} onClick={() => runCommand('formatBlock', 'blockquote')}>
                인용
              </ToolbarButton>
              <ToolbarButton type="button" onClick={handleCreateLink}>
                링크
              </ToolbarButton>
            ...
            <TextArea
              ...
              data-placeholder="공유하고 싶은 주제나 근거를 구체적으로 적어보세요"
